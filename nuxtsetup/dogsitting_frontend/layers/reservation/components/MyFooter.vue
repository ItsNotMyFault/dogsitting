<template>
    <div class="footer">
        <div class="footer-top">
            <div class="mainFooter-extendColumn" style="width: 250px;">
                <a>© {{ new Date().getFullYear() }} <b>Dogsitting</b>.
            ...
            <div class="mainFooter-extendColumn" style="width: 150px;">
                <div class="footer-socials">
                    <a rel="noopener noreferrer" target="_blank" href="https://www.facebook.com/"
                        class="_zfprdff l1ovpqvx dir dir-ltr"><svg xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 32 32" style="display:block;height:18px;width:18px;fill:currentColor"
