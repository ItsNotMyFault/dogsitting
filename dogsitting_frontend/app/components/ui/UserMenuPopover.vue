	...
	<div class="relative">
		...
		<button
			...
			<div class="hidden md:block text-left">
				...
				<div class="text-xs text-gray-500">alexis@example.com</div>
			</div>
			<Icon name="lucide:chevron-down" class="w-4 h-4 text-gray-400" />
		</button>

		<!-- Popover (always visible here for demo, remove v-if) -->
		<div class="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-xl border border-gray-200 py-2 z-50">
			<!-- User Info Header -->
			<div class="px-4 py-3 border-b border-gray-100">
				<div class="flex items-center space-x-3">
					...
					<div>
						...
						<div class="text-xs text-gray-400">My Organization</div>
					</div>
				</div>
			</div>
